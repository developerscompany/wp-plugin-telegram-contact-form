...
jQuery(document).ready(function () {
  function getWatchedForms() {
    var checkboxes = jQuery('.rft-watch-checbox');
    var watchedForms = [];
    jQuery.each(checkboxes, function () {
      if (jQuery(this).is(':checked')) {
        var formId = jQuery(this).attr('id').replace('rft-watch-', '');
  ...
  function getinputFormat() {
    var inputs = jQuery('.rft-rename-group');
    var intputsData = [];
  ...
  function getIntegrations() {
    var integration = [];
    var checkboxes = jQuery('.rft-integration-checkbox');
    var default_emails = jQuery('#default_emails[name="use_integrations"]').is(':checked');
    jQuery.each(checkboxes, function () {
      if (jQuery(this).is(':checked')) {
        var integrationName = jQuery(this).attr('id').replace('rft-watch-', '');
  ...
  function displayNavLinks() {
    ...
    if (useIntegraions) {
      var integrations = jQuery('.rft-integration-checkbox');
  ...
  jQuery('.btn-format').click(function (e) {
    ...
    var inpGroup = jQuery(this).closest('.rft-rename-group');
