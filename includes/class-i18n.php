...
class Rivo_WTS_i18n
{
    public static function texts()
    {
        return [
            ...
            'no_chats'              => __("Can't find available chats.", Rivo_WTS_TEXTDOMAIN),
            'for_update_chat_list'  => __("If you can't see required chat or group please send the text to the bot or to a group with it. And reload this page", Rivo_WTS_TEXTDOMAIN),
